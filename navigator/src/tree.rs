    ...
    pub fn new() -> Tree {
        Tree {
            ...
            tmp_lines: vec![
                ...
                ViewLine::new(" +---abcde".to_owned(), 5, 10),
                ViewLine::new("12345abcde".to_owned(), 5, 10),
                ViewLine::new("12345abcde".to_owned(), 5, 10),
                ViewLine::new("12345abcde".to_owned(), 5, 10),
                ViewLine::new("12345abcde".to_owned(), 5, 10),
                ViewLine::new("12345abcde".to_owned(), 5, 10),
                ...
                ViewLine::new("12345abcde".to_owned(), 5, 10),
                ViewLine::new("12345abcde".to_owned(), 5, 10),
                ViewLine::new("12345a4cde".to_owned(), 5, 10),
                ViewLine::new("12345a5cde".to_owned(), 5, 10),
                ViewLine::new("12345a6cde".to_owned(), 5, 10),
                ViewLine::new("12345a7cde".to_owned(), 5, 10),
                ViewLine::new("12345a8cde".to_owned(), 5, 10),
                ViewLine::new("12345abcde".to_owned(), 5, 10),
                ViewLine::new("12345abcde".to_owned(), 5, 10),
                ViewLine::new("12345abcde".to_owned(), 5, 10),
                ViewLine::new("12345abcde".to_owned(), 5, 10),
                ...
                ViewLine::new("12345abcde".to_owned(), 5, 10),
                ViewLine::new("12345abcde".to_owned(), 5, 10),
                ViewLine::new("12345abxxe".to_owned(), 5, 10),
            ],
        }
    }
